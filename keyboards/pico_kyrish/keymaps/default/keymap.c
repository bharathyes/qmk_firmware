...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_ortho_4x12(
        ...
        KC_GRV,     GUI_T(KC_EXLM),     ALT_T(KC_AT),   SFT_T(KC_HASH),  CTL_T(KC_DLR),   MEH_T(KC_PERC),                                              KC_RBRC,     KC_F4,       KC_F5,        KC_F6,        l_flower,       XXXXXXX,
        KC_BTN1,    KC_MS_L,            KC_MS_D,        KC_MS_U,         KC_MS_R,         KC_BTN2,         KC_BSLS,   _______,   KC_TILD,   KC_PIPE,   KC_SLSH,     KC_F1,       KC_F2,        KC_F3,        r_flower,       XXXXXXX,
...
// TODO: custom combo files (failed to import file) https://docs.qmk.fm/features/combo#dictionary-management
...
// const uint16_t PROGMEM bksp_combo[]     =   {KC_Y, KC_SCLN, COMBO_END};
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    return (state, _LOWER, _RAISE, _ADJUST);
}
